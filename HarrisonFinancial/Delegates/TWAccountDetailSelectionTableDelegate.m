...
@implementation TWAccountDetailSelectionTableDelegate
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    TWCallAccountDetailsViewController *controller = [[TWCallAccountDetailsViewController alloc] initWithNibName:@"CallAccountDetailsView" bundle:nil];
